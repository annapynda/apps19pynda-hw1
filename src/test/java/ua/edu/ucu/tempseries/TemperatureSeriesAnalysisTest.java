...
public class TemperatureSeriesAnalysisTest {
    ...
    @Test
    public void tesMaxWithOneElementArray() {
        double[] temperatureSeries = {-1.0};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
        double expResult = -1.0;
    ...
    @Test
    public void tesfindTempClosestToZeroWithOneElementArray() {
        double[] temperatureSeries = {-1.0};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
        double expResult = -1.0;
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testfindTempClosestToZerorWithEmptyArray() {
        double[] temperatureSeries = {};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
    ...
    @Test
    public void tesfindTempClosestToValueWithOneElementArray() {
        double[] temperatureSeries = {-1.0};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
        double expResult = -1.0;
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testfindTempClosestToValuerWithEmptyArray() {
        double[] temperatureSeries = {};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
    ...
    @Test
    public void tesfindTempsLessThaneWithOneElementArray() {
        double[] temperatureSeries = {30.0};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
        double[] expResult = {30.0};
        double[] actualResult = seriesAnalysis.findTempsLessThen(35.0);
    ...
    public void testfindTempLessThan() {
        double[] temperatureSeries = {2.8, 4.5, 6.7};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
        double[] expResult = {2.8, 4.5};
        double[] actualResult = seriesAnalysis.findTempsLessThen(5.0);
        assertArrayEquals(expResult, actualResult, 0.00001);
    }

    @Test
    public void tesfindTempsGreaterThaneWithOneElementArray() {
        double[] temperatureSeries = {30.0};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
        double[] expResult = {30.0};
        double[] actualResult = seriesAnalysis.findTempsGreaterThen(29.0);
        assertArrayEquals(expResult, actualResult, 0.00001);
    }
